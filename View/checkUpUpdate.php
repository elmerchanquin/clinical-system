...
if (isset($_POST['date'])) {
    $checkUp = $checkUpObj->updateCheckUp($_POST);
}
if (isset($_POST['code'])) {
...
<body>
    ...
    <div class="contenedor">
        <form action="<?php echo "/update-checkup/"; ?>" method="POST" autocomplete="off">
            <div class="campo">
                <input type="hidden" value="<?php print($checkUpData['id']); ?>" name="code">
            </div>
